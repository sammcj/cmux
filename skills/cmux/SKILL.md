---
name: cmux
description: Cloud VM management for development. Use this skill when users want to create, manage, or work with remote cloud development environments. Triggers on tasks involving VM creation, remote development, sandboxed environments, browser automation, or running code in isolated cloud instances.
license: MIT
metadata:
  author: manaflow
  version: "0.3.6"
