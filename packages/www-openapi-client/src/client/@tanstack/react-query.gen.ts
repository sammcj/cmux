...
export const getApiLocalWorkspaceConfigsQueryKey = (options: Options<GetApiLocalWorkspaceConfigsData>) => createQueryKey('getApiLocalWorkspaceConfigs', options);

/**
 * Get local workspace configuration
 */
export const getApiLocalWorkspaceConfigsOptions = (options: Options<GetApiLocalWorkspaceConfigsData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await getApiLocalWorkspaceConfigs({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: getApiLocalWorkspaceConfigsQueryKey(options)
    });
};
 ...
 */
export const postApiLocalWorkspaceConfigsMutation = (options?: Partial<Options<PostApiLocalWorkspaceConfigsData>>): UseMutationOptions<PostApiLocalWorkspaceConfigsResponse, DefaultError, Options<PostApiLocalWorkspaceConfigsData>> => {
    const mutationOptions: UseMutationOptions<PostApiLocalWorkspaceConfigsResponse, DefaultError, Options<PostApiLocalWorkspaceConfigsData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await postApiLocalWorkspaceConfigs({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
...
export const getApiCloudRepoConfigsQueryKey = (options: Options<GetApiCloudRepoConfigsData>) => createQueryKey('getApiCloudRepoConfigs', options);

/**
 * Get cloud repo configuration
 */
export const getApiCloudRepoConfigsOptions = (options: Options<GetApiCloudRepoConfigsData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await getApiCloudRepoConfigs({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: getApiCloudRepoConfigsQueryKey(options)
    });
};
 ...
 */
export const postApiCloudRepoConfigsMutation = (options?: Partial<Options<PostApiCloudRepoConfigsData>>): UseMutationOptions<PostApiCloudRepoConfigsResponse, DefaultError, Options<PostApiCloudRepoConfigsData>> => {
    const mutationOptions: UseMutationOptions<PostApiCloudRepoConfigsResponse, DefaultError, Options<PostApiCloudRepoConfigsData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await postApiCloudRepoConfigs({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
