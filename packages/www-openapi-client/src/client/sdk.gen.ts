 ...
 */
export const getApiLocalWorkspaceConfigs = <ThrowOnError extends boolean = false>(options: Options<GetApiLocalWorkspaceConfigsData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetApiLocalWorkspaceConfigsResponses, GetApiLocalWorkspaceConfigsErrors, ThrowOnError>({
...
/**
 * Create or update local workspace configuration
 */
export const postApiLocalWorkspaceConfigs = <ThrowOnError extends boolean = false>(options?: Options<PostApiLocalWorkspaceConfigsData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).post<PostApiLocalWorkspaceConfigsResponses, PostApiLocalWorkspaceConfigsErrors, ThrowOnError>({
        url: '/api/local-workspace-configs',
        ...options,
        headers: {
            'Content-Type': 'application/json',
...
/**
 * Get cloud repo configuration
 */
export const getApiCloudRepoConfigs = <ThrowOnError extends boolean = false>(options: Options<GetApiCloudRepoConfigsData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetApiCloudRepoConfigsResponses, GetApiCloudRepoConfigsErrors, ThrowOnError>({
...
/**
 * Create or update cloud repo configuration
 */
export const postApiCloudRepoConfigs = <ThrowOnError extends boolean = false>(options: Options<PostApiCloudRepoConfigsData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<PostApiCloudRepoConfigsResponses, PostApiCloudRepoConfigsErrors, ThrowOnError>({
        url: '/api/cloud-repo-configs',
        ...options,
        headers: {
            'Content-Type': 'application/json',
