...
import {
  getApiCloudRepoConfigsOptions,
  postApiCloudRepoConfigsMutation,
...
type CloudRepoSetupPanelProps = {
  teamSlugOrId: string;
  projectFullName: string | null;
};

export function CloudRepoSetupPanel({
  teamSlugOrId,
  projectFullName,
}: CloudRepoSetupPanelProps) {
  ...
  const saveMutation = useRQMutation(postApiCloudRepoConfigsMutation());
    ...
    saveMutation.mutate(
      ...
      },
      {
        onSuccess: () => {
          ...
          toast.success("Cloud repo setup saved");
        },
        onError: (error) => {
          console.error("[CloudRepoSetupPanel] Failed to save setup", error);
          toast.error("Failed to save cloud repo setup");
        },
      },
    );
  }, [
    ...
    <div className="mt-4 rounded-xl border border-blue-200/50 bg-blue-50/60 px-4 py-4 text-sm text-blue-900 dark:border-blue-500/30 dark:bg-blue-500/10 dark:text-blue-100">
      <div className="flex flex-col gap-1">
        ...
        <p className="text-xs text-blue-900/80 dark:text-blue-200/80">
          ...
          this configuration when creating cloud workspaces.
        </p>
      </div>
              ...
              <div className="rounded-lg border border-neutral-200 bg-white shadow-sm dark:border-neutral-800 dark:bg-neutral-950 flex flex-col h-full">
                <div className="px-3 py-3 border-b border-neutral-200 dark:border-neutral-800">
                  <div className="flex flex-col gap-1">
                    ...
                    <p className="text-xs text-neutral-500 dark:text-neutral-400">
                      Runs after we clone your repository in the cloud so
                      dependencies and services are ready.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex-1 px-3 py-3">
                  ...
                  <p className="mt-2 text-xs text-neutral-500 dark:text-neutral-400">
                    Executed from your workspace root in the cloud sandbox
                  </p>
                </div>
              </div>
            </div>
